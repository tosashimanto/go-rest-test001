...
import (
	...
	_ "github.com/lib/pq"
	"github.com/tosashimanto/go-rest-test001/bootstrap"
)
...
func postgresConn() {
	...
	// if db, err = gorm.Open("postgres", "host=localhost user=flect001 dbname=sthing_gsurvey sslmode=disable password=123456"); err != nil {
